...
class NpWebsocketClient(object): 
    def __init__(self, sel, playmode = NPSDKAPI_PLAYMODE_NPWEBSOCKET, nezip_exe_path = ".\\网际风\\"):
    ...
    def connect(self):
        try:
            ...
            if self.m_ws:
                ...
                #self.select.register(self.m_ws, selectors.EVENT_READ, self.read)
...
class NpDataPoolThread(threading.Thread):
    ...
    def __init__(self,  command_queue, response_queue, playmode, nezip_exe_path = ".\\网际风\\"):
        ...
        self.NpWsClient = NpWebsocketClient(self.sel, self._playmode, nezip_exe_path)
    ...
    def start_me(self):
        ...
        """
        self.sel.register(self.NpWsClient.m_ws, selectors.EVENT_READ, self.read)
        while True:
