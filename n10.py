...
klines1_min1 = api.fetch_klines(SYMBOL1, '1分钟线', 500) 
klines1_min5 = api.fetch_klines(SYMBOL1, '5分钟线', 500) 
klines2_day = api.fetch_klines(SYMBOL2, '日线', 500) 
klines3_min5 = api.fetch_klines(SYMBOL3, '5分钟线', 500) 

ticks1 = api.fetch_ticks(SYMBOL2)
...
while True:
    ...
    if api.is_updated(ticks1.iloc[-1],['volume','amount']):
        print("一个新tick序列")
